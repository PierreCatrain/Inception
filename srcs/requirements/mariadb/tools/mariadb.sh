...
echo "CREATE USER IF NOT EXISTS 'picatrai'@'%' IDENTIFIED BY '1234' ;" >> db.sql
echo "GRANT ALL PRIVILEGES ON db_name.* TO 'picatrai'@'%' ;" >> db.sql
echo "ALTER USER 'root'@'localhost' IDENTIFIED BY 'boss1234' ;" >> db.sql
echo "FLUSH PRIVILEGES;" >> db.sql
